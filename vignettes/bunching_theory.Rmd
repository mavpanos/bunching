...
The vignette will explain the intuition using the original setting for which bunching was developed: analyzing behavioral responses to income taxes, and will closely follow Mavrokonstantis and Seibold (2020). For a longer review, see Kleven (2016). Two main types of discontinuities are considered: kinks, i.e. changes in the slopes of choice sets, and notches, i.e. changes in the levels of choice sets. Both are supported by the `bunching` package.
...
Dharmapala, D. (2018) <https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2817151>
...
Gelber, A.M., D. Jones and Sacks, D.W. (2019) <https://home.uchicago.edu/~j1s/Jones_ET_1_19.pdf>
...
Mavrokonstantis, P. and Seibold, A. (2022) <https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4127660>
